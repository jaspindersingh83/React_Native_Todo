...
export default class App extends React.Component {
  ...
  markCompleted = (item) => {
    ...
    let newtodoarr = todos.filter(ele => ele.key !== item.key)
    this.setState({
      todos:newtodoarr
    })
  }
  ...
  render() {
    return (
      ...
      <View style={styles.container}>
        ...
        <TextInput onChangeText={this.handleTextChange} placeholder="Add Task" value = {this.state.newtodo.text}/>
          ...
          return (
            <View key= {item.key}>
               <Text style={textFont}>
                ...
                <Button onPress={() => this.markCompleted(item)} title="Delete"/>
            </View>
          )
        }}
        />
